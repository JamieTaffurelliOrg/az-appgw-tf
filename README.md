...
| <a name="input_autoscale_configuration"></a> [autoscale\_configuration](#input\_autoscale\_configuration) | Autoscale settings | <pre>object(<br>    {<br>      min_capacity               = optional(number, 2)<br>      response_buffering_enabled = optional(number, 10)<br>    }<br>  )</pre> | n/a | yes |
